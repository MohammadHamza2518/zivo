...
export const metadata: Metadata = { title: 'Privacy Policy — Zivo Talk' };

export default function Privacy() {
  const sections = [
    { title: 'Information We Collect', body: 'Zivo Talk does not collect personally identifiable information. We do not require accounts, emails, or phone numbers. Video and audio streams are transmitted peer-to-peer using WebRTC and are never stored on our servers.' },
    ...
    { title: 'Children\'s Privacy', body: 'Zivo Talk is strictly for users aged 18 and over. If you believe a minor is using the platform, please report it immediately.' },
    { title: 'Contact', body: 'For privacy concerns or any help, contact us at zivotalk@gmail.com.' },
  ];
