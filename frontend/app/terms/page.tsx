...
export const metadata: Metadata = { title: 'Terms of Service — Zivo' };

export default function Terms() {
  const sections = [
    { title: '1. Acceptance of Terms', body: 'By using Zivo you agree to these Terms of Service. If you do not agree, do not use the platform.' },
    { title: '2. Eligibility', body: 'You must be 18 years of age or older to use Zivo. By entering, you confirm you meet this requirement.' },
    ...
    { title: '4. Disclaimer of Warranties', body: 'Zivo is provided "as is" without warranties of any kind. We do not guarantee uninterrupted or error-free service.' },
    { title: '5. Limitation of Liability', body: 'Zivo is not liable for any damages arising from your use of the platform or interactions with other users.' },
