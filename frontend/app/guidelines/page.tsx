...
const RULES = [
  ...
  { emoji: '🔞', title: 'Adults Only', desc: 'You must be 18+ to use Zivo Talk. Any nudity, sexual content, or explicit behaviour will result in a permanent ban.' },
...
export default function Guidelines() {
  return (
    <div style={{ minHeight: '100vh', background: '#0a0a0f', padding: '60px 24px 60px', maxWidth: 760, margin: '0 auto' }}>
      ...
      <p style={{ color: '#64748b', fontSize: 14, lineHeight: 1.7, marginBottom: 40 }}>
        Zivo Talk is built for genuine, fun, and respectful connections. These guidelines exist to protect every person on our platform.
      </p>
